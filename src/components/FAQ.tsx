...
const FAQ: React.FC = () => {
  ...
  answer: "The annual HOA fee is $75.00 per year, due on January 1st. Late fees may be incurred if payment is not received on time. This fee covers clubhouse maintenance, street lights, clubhouse utilities, lawyers fees, and mailings."
    },
    {
      id: 2,
