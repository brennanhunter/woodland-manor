...
const Hero = () => {
  ...
  <section className="relative flex items-start justify-start overflow-hidden pt-8 sm:pt-10 pb-4" style={{ minHeight: 'calc(100vh - 120px)' }}>
      ...
      <div className="relative z-10 text-left text-white w-full max-w-7xl flex flex-col justify-end sm:justify-start h-full">
        <div className="backdrop-blur-md bg-white/10 border border-white/20 rounded-xl sm:rounded-2xl p-5 sm:p-7 lg:p-8 shadow-2xl transition-all duration-500 max-w-md sm:max-w-xl lg:max-w-2xl mx-2 sm:mx-0 sm:ml-2 lg:ml-6 mb-8 sm:mb-0 sm:mt-8">
